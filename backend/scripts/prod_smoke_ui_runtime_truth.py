...
def main() -> None:
    ...
    report = {
        ...
        "total_shadow_observations": shadow.get("total_shadow_observations"),
        "reason_shadow_count_zero": shadow.get("reason_shadow_count_zero"),
        "observation_floor": shadow.get("observation_floor"),
        "max_setup_quality_last_tick": shadow.get("max_setup_quality_last_tick"),
        "rows_scored_last_tick": shadow.get("rows_scored_last_tick"),
        "rows_above_observation_floor": shadow.get("rows_above_observation_floor"),
        "last_tick_shadow_attempts": shadow.get("last_tick_shadow_attempts"),
        "push_pull_shadow_observer_ran": shadow.get("push_pull_shadow_observer_ran"),
